<template>
  ...
  >
    ...
    >
      <h1
        class="xl:text-7xl md:text-5xl text-3xl max-w-3xl font-bold uppercase mx-auto text-center text-white"
...
const animateOnScroll = () => {
  gsap.fromTo(
    communitySection.value.children,
    { opacity: 0, y: 30 },
    {
      opacity: 1,
      y: 0,
      ...
      ease: 'power3.out',
      scrollTrigger: {
        trigger: communitySection.value.children,
        start: 'center bottom',
        end: 'bottom top',
        scrub: false,
